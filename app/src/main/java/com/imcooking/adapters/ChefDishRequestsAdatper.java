 ...
 */
public class ChefDishRequestsAdatper extends RecyclerView.Adapter<ChefDishRequestsAdatper.MyViewHolder> {
...
//    OnItemClickListenerCategory listener;
    ...
    public ChefDishRequestsAdatper(Context context,
...
//            tv_minus = view.findViewById(R.id.tv_minus);
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_chef_dish_requests, parent, false);
