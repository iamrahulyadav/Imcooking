...
public class ChefProfileData1 {
    ...
    public static class ChefDataBean {
        ...
        public String getChef_like_foodie() {
            return chef_like_foodie;
        }

        public void setChef_like_foodie(String chef_like_foodie) {
            this.chef_like_foodie = chef_like_foodie;
        }

        public String getChef_foodie_follow() {
            return chef_foodie_follow;
        }

        public void setChef_foodie_follow(String chef_foodie_follow) {
