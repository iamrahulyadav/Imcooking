...
public class Splash1Activity extends AppCompatActivity {
    ...
    String TAG = Splash1Activity.class.getName();
    ...
    private void updateLocationUI() {
        if (mCurrentLocation != null) {
            ...
            txt.setText( "Lat: " + mCurrentLocation.getLatitude() + ", " +
                    "Lng: " + mCurrentLocation.getLongitude());
                        ...
                        switch (statusCode) {
                            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                ...
                                try {
                                    ...
                                    rae.startResolutionForResult(Splash1Activity.this, REQUEST_CHECK_SETTINGS);
                            ...
                            case LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE:
                                ...
                                Toast.makeText(Splash1Activity.this, errorMessage, Toast.LENGTH_LONG).show();
                        }
